...
LOSS_SYSTEM = (
    ...
    "задачи кратко объясни вероятную причину проигрыша и дай 1–2 конкретные "
    "рекомендации, что изменить (ниша, ставка, текст, кейсы). Верни СТРОГО JSON: "
...
def set_outcome(db, job_id: int, outcome: str, revenue: int | None = None, llm=None) -> dict:
    """Mark a job's outcome. LOST triggers a post-mortem; WIN records revenue."""

...
- **Рекомендации разбора проигрыша — ТАКТИЧЕСКИЕ в рамках текущей ниши/стека** (текст, кейсы,
  ставка, вопросы, скорость). Смена основного стека/ниши из-за одного проигрыша ЗАПРЕЩЕНА
  (один кейс ≠ повод разворачивать стратегию). Если вакансия была не нашего стека — рекомендация
  улучшить фильтр квалификации, а не менять нишу.
- Канонический `task.strategy` правится через форму задачи или инструмент `update_strategy`;
  ответы/обсуждение в чате не перезаписывают канон автоматически.
